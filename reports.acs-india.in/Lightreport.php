...
<head>
    ...
    <title>JC-<?php echo ltrim($selectedReportId, 'REP_'); ?> LUX REPORT</title>
...
<body>
    ...
    <?php
    // AHU Details 
    $query2 = ("SELECT * FROM reports_ahu_details WHERE report_id='$selectedReportId' AND lg_qty > 0 AND testing_date = '$testing_date'") or die($mysqli);
    ...
    if (mysqli_num_rows($result2) > 0) {
        while ($row2 = $result2->fetch_assoc()):
            ...
            $instrument = $row2['lg_instrument_used'];
            ...
            // Obtained results for LUX
            $query4 = ("SELECT * FROM reports_lux_data WHERE ahu_seq_no ='$ahu_seq' ") or die($mysqli);
            ...
            for ($i = 1; $i <= $pr; $i++):
                ...
                $luxquery4 = ("SELECT * FROM reports_lux_data WHERE ahu_seq_no ='$ahu_seq' limit $data_per,$perpage") or die($mysqli);
                $luxresult4 = $mysqli->query($luxquery4);
                $luxrowcount = mysqli_num_rows($luxresult4);
                ?>
                <!-- ============================== LIGHT INTENSITY ============================== -->
                ...
                <table id="customer">
                    <tr>
                        <th colspan="4">LIGHT INTENSITY &nbsp; TEST REPORT</th>
                    </tr>
                ...
                <!-- ============================== LIGHT INTENSITY TESTING VALUES ============================== -->
                ...
                <table id="velo">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><span style="font-weight: bold;">Light Intensity Level (LUX) </span></td>
                    ...
                    <tr>
                        <td rowspan="<?php echo $lg_quty; ?>">
                            <?php echo $num_of_ahu++; ?>
                        </td>
                        <td rowspan="<?php echo $lg_quty; ?>">
                            <?php echo $room_detai; ?>
                        </td>
                        <?php while ($lgdata = $luxresult4->fetch_assoc()): ?>
                            <td>
                                <?php echo $lgdata['acceptance_limit']; ?>
                            </td>
                            <td>
                                <?php echo $lgdata['observed_limit']; ?>
                            </td>
                            <td>
                                <?php echo $lgdata['status']; ?>
                            </td>
                        </tr>
                    <?php endwhile; ?>
