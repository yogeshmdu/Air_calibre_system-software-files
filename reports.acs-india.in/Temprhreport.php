...
<head>
    ...
    <title>JC-<?php echo ltrim($selectedReportId, 'REP_'); ?> TRH REPORT</title>
...
<body>
    ...
    <?php
    // AHU Details 
    $query2 = ("SELECT * FROM reports_ahu_details WHERE report_id='$selectedReportId' AND temp_rh_qty > 0 AND testing_date = '$testing_date' ") or die($mysqli);
    ...
    if (mysqli_num_rows($result2) > 0) {
        while ($row2 = $result2->fetch_assoc()):
            ...
            $instrument = $row2['temp_rh_instrument_used'];
            ...
            $temp_rh_qty = $row2['temp_rh_qty'];
            $temp_txtarea = $row2['temp_txtarea'];
            ...
            $query4 = ("SELECT * FROM reports_temp_rh_data WHERE ahu_seq_no ='$ahu_seq' ") or die($mysqli);
            ...
            for ($i = 1; $i <= $pr; $i++):
                ...
                $trhquery4 = ("SELECT * FROM reports_temp_rh_data WHERE ahu_seq_no ='$ahu_seq' limit $data_per,$perpage") or die($mysqli);
                $trhresult4 = $mysqli->query($trhquery4);
                $trhrowcount = mysqli_num_rows($trhresult4);
                ?>
                ...
                <table id="customer">
                    <tr>
                        <th colspan="4">Temperature & RH &nbsp; TEST REPORT</th>
                    </tr>
                ...
                <table id="velo">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><span style="font-weight: bold;">Temperature in *C </span></td>
                        <td colspan="2"><span style="font-weight: bold;">Relative Humidity in % </span></td>
                        <td rowspan="2"><span style="font-weight: bold;">status</span></td>
                    </tr>
                    <tr>
                        <td><span style="font-weight: bold;">Limit<sapn>
                        </td>
                        <td>
                            <sapn style="font-weight: bold;">Observed</sapn>
                        </td>
                        <td><span style="font-weight: bold;">Limit<sapn>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td rowspan="<?php echo $temp_rh_qty; ?>">
                            <?php echo $num_of_ahu++; ?>
                        </td>
                        <td rowspan="<?php echo $temp_rh_qty; ?>">
                            <?php echo $room_detai; ?>
                        </td>
                        <?php while ($tempdata = $trhresult4->fetch_assoc()): ?>
                            <td>
                                <?php echo $tempdata['temperature_limit']; ?>
                            </td>
                            <td>
                                <?php echo $tempdata['temperature_observed']; ?>
                            </td>
                            <td>
                                <?php echo $tempdata['humidity_limit']; ?>
                            </td>
                            <td>
                                <?php echo $tempdata['humidity_observed']; ?>
                            </td>
                            <td>
                                <?php echo $tempdata['status']; ?>
                            </td>
                        </tr>
                    <?php endwhile; ?>
