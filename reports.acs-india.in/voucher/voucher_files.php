        ...
        <tbody class="table-light">
          ...
          while ($emp_details = $no_query_result->fetch_assoc()):
            ...
            <tr>
              ...
              <td class="first_cont ">
                <a
                  href="voucher_form_update.php?vou_format=<?php echo $vou_format; ?>&serial_no=<?php echo $serial_no; ?>&emp_id=<?php echo $emp_id; ?>&emp_name=<?php echo $emp_name; ?>&vou_date=<?php echo $vou_date; ?>&edit=1">
                  <i class="fa-solid fa-user-pen" style="color: #050505;"></i></a>
              </td>
              <td class="first_cont">
                <a href="voucher_day_view.php?vou_format=<?php echo $vou_format; ?>&serial_no=<?php echo $serial_no; ?>"> <i
                    class="fa-solid fa-eye" style="color: #030303;"></i></a>
              </td>

              <td>
                <a href="vou_img_check.php?vou_format=<?php echo $vou_format; ?>&serial_no=<?php echo $serial_no; ?>"><i
                    class="fa-regular fa-images fa-shake" style="color: #0c0d0d;"></i></a>
              </td>
              <td class="first_cont">
                <a
                  href="vou_delete.php?sl_no=<?php echo $serial_no; ?>&vou_format=<?php echo $vou_format; ?>&emp_id=<?php echo $emp_id; ?>">
                  <i onclick="return confirm('Are you sure! want to delete?')" class="fa-solid fa-trash"
                    style="color: #010409;" id="storeList"></i>
                </a>
              </td>
            </tr>
          <?php endwhile; ?>
        ...
        <tbody class="table-light">
          ...
          while ($emp_details = $no_query_result->fetch_assoc()):
            ...
            <tr>
              ...
              <td class="first_cont">
                <a href="voucher_view.php?vou_format=<?php echo $vou_format; ?>&serial_no=<?php echo $serial_no; ?>"> <i
                    class="fa-solid fa-eye" style="color: #030303;"></i></a>
              </td>
