...
<body>
    <div class="main_container text-center">
        <h3>JC-<?php echo ltrim($selectedReportId, 'REP_'); ?> FI List </h3>
    </div>
    <?php

    $testing_date_query = ("SELECT testing_date, report_id, COUNT(*) AS test_count FROM reports_ahu_details WHERE report_id ='$selectedReportId' AND filter_integrity_qty > 0 GROUP BY testing_date ORDER BY testing_date") or die($mysqli);
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center w-50">
                        <div class="ms-2 me-auto d-flex">
                            <a style="text-decoration:none;"
                                href="FIreport.php?report_id=<?php echo $report_id; ?>&testing_date=<?php echo $testing_date; ?>&total_count=<?php echo $total_count * 1; ?>">
