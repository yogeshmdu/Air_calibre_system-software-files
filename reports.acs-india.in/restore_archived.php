...
$archivedsql = "UPDATE customer_reports_master SET archived ='0' WHERE report_id = '$selectedReportId' ";

if ($mysqli->query($archivedsql) === TRUE) {
	echo "Record archived successfully";
	header("Location: archivedreports.php");
} else {
